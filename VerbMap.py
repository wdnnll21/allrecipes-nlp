verbMap = {
    "Prepare":["chop","grate","mince","crush","squeeze","cut","scramble","level","pour","slice","spread","taste","blend","bread","deglaze","aerate",
               ...
               "decorate","descale","devil","dry","ferment","flambe","fold","fillet","freeze","filter","garnish","grind","glaze","grease","hull","juice","julienne",
    ...
    "Combine":["add","layer","mix","stir","dip","bind","combine","decorate","season","drizzle","flavor","sweeten","salt","spray","sprinkle","top"],
    "Wait":["wait","cool","let"],
}
